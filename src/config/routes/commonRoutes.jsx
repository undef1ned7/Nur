...
const AdditionalServices = lazy(() => import("../../Components/pages/AdditionalServices/AdditionalServices"));
...
const BranchDetails = lazy(() => import("../../Components/pages/Branch/BranchDetails"));
const Shifts = lazy(() => import("../../Components/pages/Shifts/Shifts"));
const ShiftDetail = lazy(() => import("../../Components/pages/Shifts/ShiftDetail"));
const PosPrintSettings = lazy(() => import("../../Components/pages/Info/Settings/PosPrintSettings"));
const Obzor = lazy(() => import("../../Components/Deposits/Obzor/Obzor"));
const Zakaz = lazy(() => import("../../Components/Deposits/Zakaz/Zakaz"));
const Raspisanie = lazy(() => import("../../Components/Deposits/Raspisanie/Raspisanie"));
const BarcodePrintPage = lazy(() => import("../../Components/Deposits/Sklad/BarcodePrintPage"));
const ScalesPage = lazy(() => import("../../Components/Deposits/Sklad/ScalesPage"));
const AddProductPage = lazy(() => import("../../Components/Deposits/Sklad/AddProductPage"));
const BrandCategoryPage = lazy(() => import("../../Components/Deposits/BrandCategoryPage/BrandCategoryPage"));
const WarehouseAccounting = lazy(() => import("../../Components/Deposits/Warehouse/WarehouseAccounting"));
const Kassa = lazy(() => import("../../Components/Deposits/Kassa/Kassa"));
const KassWorker = lazy(() => import("../../Components/Deposits/KassaWorker/Kassa"));
const KassaDet = lazy(() => import("../../Components/Deposits/KassaWorkerDet/Kassa"));
const Department = lazy(() => import("../../Components/Department/Department"));
const DepartmentDetails = lazy(() => import("../../Components/DepartmentDetails/DepartmentDetails"));
const DepartmentAnalyticsChart = lazy(() => import("../../Components/DepartmentAnalyticsChart/DepartmentAnalyticsChart"));
const SectorSelect = lazy(() => import("../../Components/Sectors/SectorSelect"));
const Masters = lazy(() => import("../../Components/Sectors/Barber/Masters/Masters"));
const CafeEmployEmployeeDetail = lazy(() => import("../../Components/Sectors/Barber/Masters/CafeEmployEmployeeDetail"));
const MarketEmployEmployeeDetail = lazy(() => import("../../Components/Sectors/Barber/Masters/MarketEmployEmployeeDetail"));
