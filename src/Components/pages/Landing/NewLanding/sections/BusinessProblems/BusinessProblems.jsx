      ...
      <div className="business__container new-container">
        <div className="business__wrapper">
          <div className="col-6">
            ...
            <img  className="business__banner__img1" src={logobanner1} alt="" />
            <img  className="business__banner__img2" src={logobanner2} alt="" />
            <img  className="business__banner__img3" src={logobanner3} alt="" />
            <img className="business__banner__img4" src={logobanner4} alt="" />
            <img className="business__banner__img5" src={logobanner5} alt="" />
            </div>
          </div>
