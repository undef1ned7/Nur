 ...
 *     ],
 *     "money_by_date": [
 *       { "date": "2026-02-20", "receipt_amount": "100", "expense_amount": "40", "net_amount": "60" }
 *     ]
 *   },
 *   "top_agents": {
 *     "by_sales": [
 ...
 *       { "category_name": "…", "amount": "100.00", "docs_count": 2 }
 *     ],
 *     "money_expenses_by_category": [
 *       { "category_name": null, "amount": "50.00", "docs_count": 1 }
 *     ]
 *   }
 * }
 */
...
const cashRegisterRowLabel = (row) => {
...
const moneyCategoryLabel = (row) => {
  const name = row.category_name ?? row.name ?? row.category?.name;
    ...
    <div className="warehouse-analytics">
      ...
      {loading ? (
        ...
        <>
          ...
          {(showAgentSalesAnalytics || isOwnerOrAdmin) && (
          ...
          {isOwnerOrAdmin && (
            <>
              <div className="warehouse-analytics__accordion">
                ...
                <AccordionItem
                  id="wa-cash-by-register"
                  title="Кассы и счета"
                  icon={Wallet}
                  badge={
                    cashByRegister.length ? `${cashByRegister.length}` : "0"
                  }
                  defaultOpen={false}
                >
                  <div className="warehouse-analytics__card warehouse-analytics__accCard">
                    {cashByRegister.length > 0 ? (
                      <PaginatedTable
                        ...
                        rows={cashByRegister.map((r) => [
                          ...
                          formatNum(r.receipt_amount ?? 0),
                          formatNum(r.expense_amount ?? 0),
                          formatNum(r.net_amount ?? 0),
                ...
                <AccordionItem
                  id="wa-money-receipts-categories"
                ...
                <AccordionItem
                  id="wa-money-expenses-categories"
