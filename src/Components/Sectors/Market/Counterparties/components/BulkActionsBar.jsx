...
const BulkActionsBar = ({
  ...
  const getSelectedText = () => {
    if (selectedCount === 1) return "контрагент выбран";
    if (selectedCount < 5) return "контрагента выбрано";
    return "контрагентов выбрано";
  };
      ...
      <div className="warehouse-bulk-actions__content">
        ...
        <div className="warehouse-bulk-actions__buttons">
          ...
          <button
            ...
            disabled={isDeleting}
            title="Удалить выбранные контрагенты"
          >
            <Trash2 size={16} />
