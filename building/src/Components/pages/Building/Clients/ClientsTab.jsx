...
export default function ClientsTab() {
  ...
  return (
    <>
                ...
                {effectiveList.map((c) => {
                  ...
                  return (
                    <tr
                      ...
                      onClick={() =>
                        id && navigate(`/building/clients/${id}`)
                      }
                    >
                      <td>{c?.name || "—"}</td>
                      <td>{c?.phone || "—"}</td>
      ...
      >
        <form className="add-product-page add-product-page--modal-form" onSubmit={handleSubmit}>
          {formError && (
          ...
          <div className="add-product-page__form-group">
            <label className="add-product-page__label">ИНН</label>
            <input
              className="add-product-page__input"
              value={form.inn}
          ...
          <div className="add-product-page__form-group">
            <label className="add-product-page__label">Адрес</label>
            <input
              className="add-product-page__input"
              value={form.address}
          ...
          <div className="add-product-page__form-group">
            <label className="add-product-page__checkbox">
              <input
                type="checkbox"
