...
Смысл:
- Если сотруднику назначили 1+ ЖК, то в модуле Building он **видит данные только по назначенным ЖК** (для всех эндпоинтов, где есть привязка к ЖК: квартиры, чертежи, договора, процесс работ, закупки/склад и т.д.).
...
Кто может управлять назначениями:
